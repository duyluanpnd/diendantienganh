			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="profile.html#" class="dropdown-toggle">
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a href="profile.html#">More Pages</a>
						</li>
									...
									<div class="col-xs-12 col-sm-9">
										...
										<div class="profile-user-info profile-user-info-striped">
											<div class="profile-info-row">
												...
												<div class="profile-info-value">{{$x}} </div>
											</div>
										</div>
									</div>
								</div>
								...
								<div id="user-profile-2" class="user-profile">
									<div class="tabbable">
										<ul class="nav nav-tabs padding-18">
											<li class="active">
												<a data-toggle="tab" href="profile.html#home">
											...
											<li>
												<a data-toggle="tab" href="profile.html#feed">
											...
											<li>
												<a data-toggle="tab" href="profile.html#friends">
											...
											<li>
												<a data-toggle="tab" href="profile.html#pictures">
										...
										<div class="tab-content no-border padding-24">
											<div id="home" class="tab-pane in active">
												<div class="row">
													<div class="col-xs-12 col-sm-3 center">
														<span class="profile-picture">
															<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="images/profile-pic.jpg" />
														</span>

														<div class="space space-4"></div>

														<a href="profile.html#" class="btn btn-sm btn-block btn-success">
															<i class="ace-icon fa fa-plus-circle bigger-120"></i>
															<span class="bigger-110">Add as a friend</span>
														</a>

														<a href="profile.html#" class="btn btn-sm btn-block btn-primary">
													...
													<div class="col-xs-12 col-sm-9">
														...
														<div class="profile-user-info">
															<div class="profile-info-row">
																<disv class="profile-info-name"> Username </div>
												...
												<div class="profile-feed row">
													<div class="col-sm-6">
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="Alex Doe's avatar" src="images/avatar5.png" />
																<a class="user" href="profile.html#"> Alex Doe </a>
																changed his profile photo.
																<a href="profile.html#">Take a look</a>
															...
															<div class="tools action-buttons">
																<a href="profile.html#" class="blue">
																	<i class="ace-icon fa fa-pencil bigger-125"></i>
																</a>

																<a href="profile.html#" class="red">
														...
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="Susan Smith's avatar" src="images/avatar1.png" />
																<a class="user" href="profile.html#"> Susan Smith </a>
														...
														<div class="profile-activity clearfix">
															<div>
																...
																<a class="user" href="profile.html#"> Alex Doe </a>
																joined
																<a href="profile.html#">Country Music</a>
														...
														<div class="profile-activity clearfix">
															<div>
																<img class="pull-left" alt="David Palms's avatar" src="images/avatar4.png" />
																<a class="user" href="profile.html#"> David Palms </a>
													...
													<div class="col-sm-6">
														<div class="profile-activity clearfix">
															<div>
																...
																<a href="profile.html#">Read now</a>
											...
											<div id="friends" class="tab-pane">
												<div class="profile-users clearfix">
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar4.png" alt="Bob Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar1.png" alt="Rose Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar.png" alt="Jim Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar5.png" alt="Alex Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar2.png" alt="Phil Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar3.png" alt="Susan Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar1.png" alt="Jennifer Doe's avatar" />
																</a>
															</div>
													...
													<div class="itemdiv memberdiv">
														<div class="inline pos-rel">
															<div class="user">
																<a href="profile.html#">
																	<img src="images/avatar3.png" alt="Alexa Doe's avatar" />
																</a>
															</div>
												...
												<ul class="pager pull-right">
													<li class="previous disabled">
														<a href="profile.html#">&larr; Prev</a>
													</li>

													<li class="next">
														<a href="profile.html#">Next &rarr;</a>
													</li>
												</ul>
											</div><!-- /#friends -->
											...
											<div id="pictures" class="tab-pane">
												<ul class="ace-thumbnails">
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-1.jpg" />
															<div class="text">
													...
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-2.jpg" />
															<div class="text">
																<div class="inner">Sample Caption on Hover</div>
															</div>
														</a>
													...
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-3.jpg" />
															<div class="text">
																<div class="inner">Sample Caption on Hover</div>
															</div>
														</a>
													...
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-4.jpg" />
															<div class="text">
																<div class="inner">Sample Caption on Hover</div>
															</div>
														</a>
													...
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-5.jpg" />
															<div class="text">
																<div class="inner">Sample Caption on Hover</div>
															</div>
														</a>
													...
													<li>
														<a href="profile.html#" data-rel="colorbox">
															<img alt="150x150" src="images/thumb-6.jpg" />
															<div class="text">
																<div class="inner">Sample Caption on Hover</div>
															</div>
														</a>
										...
										<form class="form-horizontal">
											<div class="tabbable">
												<ul class="nav nav-tabs padding-16">
													<li class="active">
														<a data-toggle="tab" href="profile.html#edit-basic">
													...
													<li>
														<a data-toggle="tab" href="profile.html#edit-settings">
													...
													<li>
														<a data-toggle="tab" href="profile.html#edit-password">
