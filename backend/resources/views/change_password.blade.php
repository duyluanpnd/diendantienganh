		...
		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="form-elements.html#" class="navbar-brand">
						<small>
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="grey">
							<a data-toggle="dropdown" class="dropdown-toggle" href="form-elements.html#">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="form-elements.html#" class="dropdown-toggle">
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="form-elements.html#" class="dropdown-toggle">
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li>
							...
							<a href="form-elements.html#">Home</a>
						</li>

						<li>
							<a href="form-elements.html#">Đổi mật khẩu</a>
						</li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<form class="form-horizontal" role="form" action="{{URL::to('/changepassword')}}" method="POST">
							{{csrf_field()}}
			...
			<a href="form-elements.html#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
