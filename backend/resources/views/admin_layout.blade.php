...
<link rel="stylesheet" href="{{asset('backend/css/jquery-ui.custom.min.css')}}" />
<link rel="stylesheet" href="{{asset('backend/css/chosen.css')}}" />
<link rel="stylesheet" href="{{asset('backend/css/datepicker.css')}}" />
<link rel="stylesheet" href="{{asset('backend/css/bootstrap-timepicker.css')}}" />
...
<link rel="stylesheet" href="{{asset('backend/css/colorbox.css')}}" />
<link rel="stylesheet" href="{{asset('backend/css/ui.jqgrid.css')}}" />
...
<link rel="stylesheet" href="{{asset('backend/css/bootstrap-editable.css')}}" />
<!-- text fonts -->
...
<!--[if lte IE 9]>
    <link rel="stylesheet" href="{{asset('backend/css/ace-part2.min.css')}}" />
<![endif]-->
...
<![endif]-->
<link rel="stylesheet" href="{{asset('backend/css/more.css')}}" />
...
<!--[if IE]>
<script type="text/javascript">
window.jQuery || document.write("<script src='{{asset('backend/js/jquery1x.min.js')}}'>"+"<"+"/script>");
</script>
<![endif]-->
<script type="text/javascript">
...
<script src="{{asset('backend/js/fuelux.spinner.min.js')}}"></script>
...
<script src="{{asset('backend/js/jquery.inputlimiter.1.3.1.min.js')}}"></script>
<script src="{{asset('backend/js/jquery.maskedinput.min.js')}}"></script>
<script src="{{asset('backend/js/bootstrap-tag.min.js')}}"></script>
<script src="{{asset('backend/js/fuelux.wizard.min.js')}}"></script>
...
<script src="{{asset('backend/js/jquery.jqGrid.min.js')}}"></script>
<script src="{{asset('backend/js/grid.locale-en.js')}}"></script>
...
<script src="{{asset('backend/js/ace-editable.min.js')}}"></script>
<script src="{{asset('backend/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('backend/js/jquery.dataTables.bootstrap.js')}}"></script>
<script src="{{asset('backend/js/markdown.min.js')}}"></script>
<script src="{{asset('backend/js/bootstrap-markdown.min.js')}}"></script>
